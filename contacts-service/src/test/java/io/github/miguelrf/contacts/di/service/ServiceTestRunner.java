...
public class ServiceTestRunner extends BlockJUnit4ClassRunner {
	...
	protected Object createTest() throws Exception {
		...
		ContactsConfiguration config = getConfiguration(test);
	...
	private ContactsConfiguration getConfiguration(Object test) {
		...
		try {
			...
			if (ruleField.isPresent()) {
				...
				return (ContactsConfiguration) rule.getConfiguration();
			}
